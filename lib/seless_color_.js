/* ! jQuery Color v@2.1.2 with SVG Color Names
 * http://github.com/jquery/jquery-color | jquery.org/license
 */
(function (a, b) {
    function m(a, b, c) {
        var d = h[b.type] || {};
    ...
    var c = "backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopCo" +
            ...
            if (j === "object") 
                return c instanceof f
                    ...
                    : l(g, function (b, d) {
                        ...
                        i[e] && a.inArray(null, i[e].slice(0, 3)) < 0 && (i[e][3] = 1, d.from && (
                            i._rgba = d.from(i[e])
                        ))
                    }),
                this
            ...
            f.fn[b] = function (f) {
                ...
                return g === "undefined"
                    ...
                    : (
                        ...
                        f == null && e.empty
                            ? this
                            : (g === "string" && (k = d.exec(f), k && (f = j + parseFloat(k[2]) * (
                                k[1] === "+"
                                    ? 1
                                    : -1
                            ))), i[e.idx] = f, this[h](i))
        ...
        l(c, function (b, c) {
            ...
            a
                ...
                .step[c] = function (b) {
                    ...
                    a
                        .cssHooks[c]
                        .set(b.elem, b.start.transition(b.end, b.pos))
                }
        })
    },
    f.hook(c),
